  ...
  return (
    <main className='bg-dark-base shadow-dark-content/10 mx-auto h-[297mm] min-h-fit w-[210mm] bg-[url(/dark-bg.png)] bg-contain bg-no-repeat px-16 shadow'>
      <section className='w-full pt-12 text-center'>
        <h2 className='text-dark-content-darker mb-1 text-3xl font-bold'>{data.personalInfo.fullName}</h2>
        <h3 className='mb-5 text-xs'>{data.personalInfo.designation}</h3>
        <div className='text-dark-content-darker flex items-center justify-center gap-2 text-[9px]'>
        ...
        <div className='mt-4 flex items-center justify-center gap-1 text-[8px]'>
          {Object.entries(data.socialLinks).map((key, index) => (
            <div
              key={index}
              className={clsx('bg-dark-content flex items-center gap-[2px] rounded-full border px-2 py-1', {
      ...
      <section className='border-dark-content/10 mt-20 grid grid-cols-4 gap-5 border-b text-[9px]'>
      ...
      <section className='border-dark-content/10 mt-4 grid grid-cols-4 gap-5 border-b text-[9px]'>
